...
- OBLIGACIONES: Aunque no paguen impuestos en USA, toda LLC de propietario extranjero debe presentar anualmente el Formulario 5472 junto con el 1120 proforma al IRS para evitar multas de $25.000. Open LLC USA ofrece este servicio por $297. EXCEPCIÓN: esa obligación solo existe si durante el año hubo transacciones que deban reportarse en las Partes IV, V y VI del Formulario 5472 (aportaciones de capital, distribuciones, importes pagados o recibidos con motivo de la formación, disolución, adquisición o transmisión de la entidad y, en general, cualquier operación con el propietario extranjero). Si la LLC no tuvo ninguna de esas transacciones en todo el año, el IRS no exige presentar el formulario. En la práctica casi toda LLC activa tiene alguna, porque la propia aportación inicial ya cuenta. IMPORTANTE: al responder si hay que presentar el 5472, aplica SIEMPRE este criterio de las Partes IV, V y VI; el material de apoyo del negocio describe la obligación en general y puede no recoger la excepción, pero el prompt manda sobre él.

    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #222; max-width: 600px; margin: 0 auto;">
          ...
          <p>Un especialista en español te contactará personalmente por email en menos de 12 horas.</p>
          ...
          <p style="margin: 30px 0 10px;">
            <strong>¿Prefieres no esperar?</strong> Habla directamente con nosotros:
          </p>

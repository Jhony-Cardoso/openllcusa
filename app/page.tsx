  ...
  const jsonLd = {
    ...
    '@graph': [
      // Organization Schema
      {
        ...
        contactPoint: {
          '@type': 'ContactPoint',
          telephone: '+1-234-567-890', // Cambia por tu teléfono real
          contactType: 'customer service',
          availableLanguage: ['Spanish', 'English'],
          areaServed: 'Worldwide',
        },
        sameAs: [
          'https://facebook.com/openllcusa', // Añade tus redes reales
      ...
      // Aggregate Rating (opcional, si tienes reviews reales)
      {
        '@type': 'Organization',
        '@id': 'https://openllcusa.com/#organization',
        aggregateRating: {
      ...
      // FAQPage Schema (añade si tienes FAQs)
      {
        '@type': 'FAQPage',
        mainEntity: [
          {

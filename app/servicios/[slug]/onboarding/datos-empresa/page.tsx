...
export default function DatosEmpresaPage() {
  ...
  if (!isEIN) {
    // Si no es EIN, deja el flujo LLC como estaba: vuelve a revisión
    return (
      <div className="max-w-2xl">
        <h1 className="text-3xl font-semibold text-gray-900 mb-2">Datos de tu empresa</h1>

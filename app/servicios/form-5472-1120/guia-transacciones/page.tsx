...
export const metadata = {
    title: 'Guía de Transacciones Formulario 5472 - Open LLC USA',
    description: 'Guía completa sobre cómo identificar y registrar transacciones reportables (Part V) para tu Formulario 5472 según la normativa del IRS.',
}
        ...
        <div className="min-h-screen bg-slate-50 flex flex-col">
            <header className="bg-white border-b border-slate-200 py-6 sticky top-0 z-10">
                <div className="max-w-4xl mx-auto px-6 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-black text-slate-900 leading-tight">Guía de Transacciones Reportables</h1>
                ...
                <article className="max-w-4xl mx-auto px-6 space-y-12">
                    ...
                    <section className="bg-white rounded-3xl p-8 lg:p-12 shadow-sm border border-slate-200">
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <h2 className="text-2xl font-black text-slate-900">¿Qué busca el IRS con esto?</h2>
                        </div>
                        <div className="space-y-4 text-slate-700 leading-relaxed text-lg">
                            <p>
                                El Formulario 5472 no es para pagar impuestos directamente. Su objetivo principal es <strong>reportar información de transparencia</strong> sobre el movimiento de capitales y bienes.
                            </p>
                            <p>
                                El IRS necesita saber exactamente cómo interactúas financieramente tú (como propietario extranjero) con tu empresa en USA (la LLC). Específicamente, quieren observar cualquier transferencia de valor que cruce la frontera entre tú como individuo y tu LLC.
                            </p>
                        </div>
                    </section>

                    {/* Sección 2: Transacciones Reportables */}
                    <section className="space-y-6">
                        <h2 className="text-2xl font-black text-slate-900 px-4">¿Cuáles son las 'Transacciones Reportables'?</h2>
                            ...
                            <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-blue-100 relative overflow-hidden group">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <ul className="space-y-3">
                                        ...
                                        <li className="flex items-start gap-3 text-sm text-slate-700 font-medium">
                                            <CheckCircle2 size={18} className="text-emerald-500 mt-0.5 flex-shrink-0" />
                                            <span>Gastos de constitución de la LLC pagados con tu tarjeta personal.</span>
                                        </li>
                                        <li className="flex items-start gap-3 text-sm text-slate-700 font-medium">
                                            <CheckCircle2 size={18} className="text-emerald-500 mt-0.5 flex-shrink-0" />
                            ...
                            <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-emerald-100 relative overflow-hidden group">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <ul className="space-y-3">
                                        ...
                                        <li className="flex items-start gap-3 text-sm text-slate-700 font-medium">
                                            <CheckCircle2 size={18} className="text-emerald-500 mt-0.5 flex-shrink-0" />
                                            <span>Pagos usando la tarjeta débito de la LLC para gastos estrictamente personales (ropa personal, comida fuera del horario laboral, etc).</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    {/* Sección 3: Lo que NO se reporta */}
                    <section className="bg-amber-50 rounded-3xl p-8 lg:p-12 shadow-inner border border-amber-100">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                            <div className="bg-white/60 rounded-xl p-4 font-bold text-sm text-amber-800 border-l-4 border-amber-400">
                                ❌ Ingresos o cobros de honorarios recibidos de tus clientes reales (Stripe, facturas, etc.).
                            </div>
                            <div className="bg-white/60 rounded-xl p-4 font-bold text-sm text-amber-800 border-l-4 border-amber-400">
                                ❌ Pagos a terceros y proveedores externos (pago de servidores web, suscripciones, freelancers de Upwork).
                            </div>
                        </div>
                    </section>
                    ...
                    <div className="flex flex-col items-center justify-center p-8 bg-slate-900 text-white rounded-[2.5rem] shadow-xl text-center">
                        ...
                        <p className="text-slate-300 font-medium max-w-xl mx-auto mb-8">
                            Vuelve a la pestaña anterior y empieza a añadir fila por fila. Si has agrupado muchas transferencias a tu banco en el año (por ejemplo, 10 transferencias a España), trata de agruparlas por mes o añádelas todas por separado para mayor precisión.
                        </p>
